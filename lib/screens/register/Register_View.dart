...
import 'package:arena_sports_app/screens/createUser/CreateUserView.dart';
            ...
            children: [
              Container(
                margin: EdgeInsets.only(
                  top: SizeConfig.blockSizeVertical * 6.0,
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onFieldSubmitted: (v) {
                                    ...
                                    FocusScope.of(context)
                                        .requestFocus(repeatPasswordFocus);
                                  },
                                  cursorColor: AppTheme.blackColor,
                                  decoration: InputDecoration(
                                      focusedBorder: const UnderlineInputBorder(
                                      ...
                                      if (_formKey.currentState.validate()) {
                                        if (Controllers.name.text.isNotEmpty &&
                                          ...
                                          if (validateEmail((Controllers
                                            ...
                                            if (Controllers
                                                .dob.text.isNotEmpty) {
                                              if (Controllers.registerPassword
                                                      .text.isNotEmpty &&
                                                  Controllers.registerPassword
                                                          .text.length >=
                                                      8) {
                                                if (Controllers
                                                        .repeatPassword.text ==
