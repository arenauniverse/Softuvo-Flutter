...
import '../CommonWidgets/SizeConfig.dart';
import '../CommonWidgets/SizeConfig.dart';
import '../SelectSportsBottomSheet/SelectSportsBottomSheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Container(
        ...
        width:SizeConfig.blockSizeHorizontal*80,height:SizeConfig.blockSizeVertical*9,
          child:Row(
            children: [
      Container(width:SizeConfig.blockSizeHorizontal*80,height:SizeConfig.blockSizeVertical*9,color: Colors.white,
          ...
          /*  BottomNavigationBarItem(
            ...
            /* BottomNavigationBarItem(
              ...
              Align(alignment: Alignment.center,
                child: Container(
                width: SizeConfig.blockSizeHorizontal*20,alignment: Alignment.center,height: SizeConfig.blockSizeVertical*9,color: Colors.white,
            ...
            child: SvgPicture.asset(
                  'assets/tab5.svg',alignment: Alignment.center,
